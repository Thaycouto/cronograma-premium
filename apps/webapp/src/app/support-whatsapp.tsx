...
export function SupportWhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 inline-flex items-center gap-2 rounded-full border border-[#140b10]/10 bg-[#fffaf6]/95 px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#140b10] shadow-[0_20px_60px_rgba(62,18,36,0.18)] backdrop-blur transition hover:-translate-y-0.5 hover:border-[#ad2d63]/35 md:bottom-5 md:right-6"
